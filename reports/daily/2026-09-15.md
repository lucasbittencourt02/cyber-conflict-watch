...
- **Estado:** `DEGRADED`
- **Última coleta (São Paulo):** `2026-09-15 04:39:20 -03`
- **Última coleta (UTC):** `2026-09-15 07:39:20 UTC`
- **Arquivo bruto:** `data/daily/2026-09-15_07-39-20.json`
...
|---:|---:|---|---|
| 1 | 23 | telnet | Telnet |
| 2 | 443 | https | HTTP protocol over TLS SSL |
| 3 | 22 | ssh | SSH Remote Login Protocol |
...
| 2 | `64.62.156.0/24` | 24 | 348 | HURRICANE | US |
| 3 | `69.5.169.0/24` | 24 | 344 | OMNIS | US |
| 4 | `66.240.223.0/24` | 24 | 342 | CARINET | US |
| 5 | `45.135.193.0/24` | 24 | 339 | - | - |
| 6 | `64.62.197.0/24` | 24 | 339 | HURRICANE | US |
| 7 | `138.226.239.0/24` | 24 | 338 | - | - |
| 8 | `213.209.159.0/24` | 24 | 335 | AS43260 | TR |
| 9 | `77.239.124.0/24` | 24 | 334 | - | - |
| 10 | `193.163.125.0/24` | 24 | 334 | INTERNET-MEASUREMENT | GB |


## [OBSERVAÇÃO] Mídia e contexto relacionado ao conflito — GDELT

> ⚠️ **GDELT em cache.** Dados reutilizados de `2026-09-15_01-30-32.json` (idade aproximada: **6.15 h**).
