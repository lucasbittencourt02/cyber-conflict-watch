...
- **Estado:** `DEGRADED`
- **Última coleta (São Paulo):** `2026-09-15 11:18:23 -03`
- **Última coleta (UTC):** `2026-09-15 14:18:23 UTC`
- **Arquivo bruto:** `data/daily/2026-09-15_14-18-23.json`
...
> ⚠️ **GDELT em cache.** Dados reutilizados de `2026-09-15_01-30-32.json` (idade aproximada: **12.8 h**).
