...
- **Estado:** `PARTIAL`
- **Última coleta (São Paulo):** `2026-09-14 22:38:33 -03`
- **Última coleta (UTC):** `2026-09-15 01:38:33 UTC`
- **Arquivo bruto:** `data/daily/2026-09-15_01-38-33.json`
...
|---:|---|---:|---:|---|---|
| 1 | `66.132.195.0/24` | 24 | 351 | - | - |
| 2 | `85.217.140.0/24` | 24 | 350 | NETERRA-AS | BG |
| 3 | `198.235.24.0/24` | 24 | 345 | GOOGLE-CLOUD-PLATFORM | US |
| 4 | `205.210.31.0/24` | 24 | 345 | GOOGLE-CLOUD-PLATFORM | US |
| 5 | `147.185.132.0/24` | 24 | 343 | GOOGLE-CLOUD-PLATFORM | US |
| 6 | `65.49.1.0/24` | 24 | 338 | HURRICANE | US |
| 7 | `193.163.125.0/24` | 24 | 337 | INTERNET-MEASUREMENT | GB |
| 8 | `69.5.169.0/24` | 24 | 334 | OMNIS | US |
| 9 | `216.180.246.0/24` | 24 | 334 | NTHL | US |
| 10 | `66.132.172.0/24` | 24 | 333 | - | - |


## [OBSERVAÇÃO] Mídia e contexto relacionado ao conflito — GDELT

A fonte GDELT não respondeu corretamente nesta coleta. Erro registrado: `429 Client Error: Too Many Requests for url: https://api.gdeltproject.org/api/v2/doc/doc?query=%28Israel+OR+Palestine+OR+Gaza%29+%28cyber+OR+cyberattack+OR+hacking+OR+DDoS+OR+malware+OR+phishing+OR+hacktivist+OR+hacktivism+OR+%22internet+outage%22+OR+telecommunications+OR+blackout%29&mode=ArtList&format=json&maxrecords=75&timespan=1d&sort=HybridRel`.
