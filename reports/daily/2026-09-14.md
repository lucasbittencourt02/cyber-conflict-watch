...
- **Estado:** `DEGRADED`
- **Última coleta (São Paulo):** `2026-09-14 22:49:29 -03`
- **Última coleta (UTC):** `2026-09-15 01:49:29 UTC`
- **Arquivo bruto:** `data/daily/2026-09-15_01-49-29.json`
...
A fonte GDELT não respondeu corretamente nesta coleta. Erro registrado: `erro não informado`.
