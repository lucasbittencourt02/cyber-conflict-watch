...
- **Estado:** `DEGRADED`
- **Última coleta (São Paulo):** `2026-09-16 04:37:55 -03`
- **Última coleta (UTC):** `2026-09-16 07:37:55 UTC`
- **Arquivo bruto:** `data/daily/2026-09-16_07-37-55.json`
...
| 6 | 2222 | ssh | alternative ssh (Cowrie) |
| 7 | 16767 | --- | --- |
| 8 | 8000 | irdmi | iRDMI |
...
| 2 | `156.225.1.0/24` | 24 | 344 | OCTL-AS-AP OceanBlue Cloud Technology Limited | HK |
...
| 6 | `85.217.140.0/24` | 24 | 340 | NETERRA-AS | BG |
| 7 | `138.226.239.0/24` | 24 | 339 | - | - |
| 8 | `193.163.125.0/24` | 24 | 338 | INTERNET-MEASUREMENT | GB |
| 9 | `77.239.124.0/24` | 24 | 337 | - | - |
| 10 | `85.217.149.0/24` | 24 | 337 | MAYAK | BG |


## [OBSERVAÇÃO] Mídia e contexto relacionado ao conflito — GDELT

> ⚠️ **GDELT em cache.** Dados reutilizados de `2026-09-15_01-30-32.json` (idade aproximada: **30.12 h**).
