...
- **Estado:** `PARTIAL`
- **Última coleta (São Paulo):** `2026-09-25 04:41:31 -03`
- **Última coleta (UTC):** `2026-09-25 07:41:31 UTC`
- **Arquivo bruto:** `data/daily/2026-09-25_07-41-31.json`
...
|---:|---:|---|---|
| 1 | 2222 | ssh | alternative ssh (Cowrie) |
| 2 | 23 | telnet | Telnet |
...
|---:|---|---:|---:|---|---|
| 1 | `16.5.0.0/24` | 24 | 360 | - | - |
| 2 | `45.198.224.0/24` | 24 | 345 | OWS | US |
| 3 | `64.62.197.0/24` | 24 | 341 | HURRICANE | US |
| 4 | `198.235.24.0/24` | 24 | 341 | GOOGLE-CLOUD-PLATFORM | US |
| 5 | `77.239.124.0/24` | 24 | 338 | - | - |
| 6 | `193.163.125.0/24` | 24 | 337 | INTERNET-MEASUREMENT | GB |
| 7 | `195.184.76.0/24` | 24 | 337 | EAJ-GLOBAL | GB |
| 8 | `45.156.128.0/24` | 24 | 333 | AS-BITSIGHT | PT |
| 9 | `85.217.140.0/24` | 24 | 332 | NETERRA-AS | BG |
| 10 | `148.59.129.0/24` | 24 | 331 | SERVER-MANIA | CA |
